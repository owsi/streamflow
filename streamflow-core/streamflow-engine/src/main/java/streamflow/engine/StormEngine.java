...
public class StormEngine {
    ...
    public ClusterSummary getClusterSummary(Cluster cluster) {
        org.apache.storm.generated.ClusterSummary summary = null;
        ...
        if (summary != null) {
            ...
            for (org.apache.storm.generated.SupervisorSummary ss : summary.get_supervisors()) {
            ...
            for (org.apache.storm.generated.TopologySummary ts : summary.get_topologies()) {
    ...
    public TopologyInfo getTopologyInfo(Topology topology) {
        org.apache.storm.generated.TopologyInfo info = null;
        ...
        */
        ...
        if (info != null) {
            ...
            for (Map.Entry<String, List<org.apache.storm.generated.ErrorInfo>> error
                    : info.get_errors().entrySet()) {
                List<ErrorInfo> errorInfoList = new ArrayList<>();
                for (org.apache.storm.generated.ErrorInfo ei : error.getValue()) {
            ...
            for (org.apache.storm.generated.ExecutorSummary es : info.get_executors()) {
                ...
                org.apache.storm.generated.ExecutorInfo ei = es.get_executor_info();
                if (ei != null) {
                ...
                org.apache.storm.generated.ExecutorStats eStats = es.get_stats();
                if (eStats != null) {
                    ExecutorStats stats = new ExecutorStats();
                    stats.setEmitted(eStats.get_emitted());
                    stats.setTransferred(eStats.get_transferred());

                    org.apache.storm.generated.ExecutorSpecificStats ess = eStats.get_specific();
                    if (ess != null) {
                        ExecutorSpecificStats specific = new ExecutorSpecificStats();

                        if (ess.is_set_bolt()) {
                            org.apache.storm.generated.BoltStats bs = ess.get_bolt();
                            if (bs != null) {
                                BoltStats boltStats = new BoltStats();

                                for (Map.Entry<String, Map<org.apache.storm.generated.GlobalStreamId, Long>> ae
                                        : bs.get_acked().entrySet()) {
                                    Map<String, Long> ackedMap = new HashMap<>();

                                    for (Map.Entry<org.apache.storm.generated.GlobalStreamId, Long> aem
                                            : ae.getValue().entrySet()) {
                                        org.apache.storm.generated.GlobalStreamId gsi = aem.getKey();
                                ...
                                for (Map.Entry<String, Map<org.apache.storm.generated.GlobalStreamId, Long>> fe
                                        : bs.get_failed().entrySet()) {
                                    Map<String, Long> failedMap = new HashMap<>();

                                    for (Map.Entry<org.apache.storm.generated.GlobalStreamId, Long> fem
                                            : fe.getValue().entrySet()) {
                                        org.apache.storm.generated.GlobalStreamId gsi = fem.getKey();
                                ...
                                for (Map.Entry<String, Map<org.apache.storm.generated.GlobalStreamId, Long>> ee
                                        : bs.get_executed().entrySet()) {
                                    Map<String, Long> executedMap = new HashMap<>();

                                    for (Map.Entry<org.apache.storm.generated.GlobalStreamId, Long> eem
                                            : ee.getValue().entrySet()) {
                                        org.apache.storm.generated.GlobalStreamId gsi = eem.getKey();
                                ...
                                for (Map.Entry<String, Map<org.apache.storm.generated.GlobalStreamId, Double>> ema
                                        : bs.get_execute_ms_avg().entrySet()) {
                                    Map<String, Double> executedMap = new HashMap<>();

                                    for (Map.Entry<org.apache.storm.generated.GlobalStreamId, Double> emam
                                            : ema.getValue().entrySet()) {
                                        org.apache.storm.generated.GlobalStreamId gsi = emam.getKey();
                                ...
                                for (Map.Entry<String, Map<org.apache.storm.generated.GlobalStreamId, Double>> pma
                                        : bs.get_process_ms_avg().entrySet()) {
                                    Map<String, Double> processMap = new HashMap<>();

                                    for (Map.Entry<org.apache.storm.generated.GlobalStreamId, Double> pmam
                                            : pma.getValue().entrySet()) {
                                        org.apache.storm.generated.GlobalStreamId gsi = pmam.getKey();
                        ...
                        if (ess.is_set_spout()) {
                            org.apache.storm.generated.SpoutStats ss = ess.get_spout();
                            if (ss != null) {
