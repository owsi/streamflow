...
public class PartitionedTridentSpoutWrapper extends BaseWrapper<IPartitionedTridentSpout>
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(PartitionedTridentSpoutWrapper.class);

    public PartitionedTridentSpoutWrapper(Topology topology, TopologyComponent component,
            boolean isCluster, StreamflowConfig configuration) throws FrameworkException {
        super(topology, component, isCluster, configuration, IPartitionedTridentSpout.class);
    }
